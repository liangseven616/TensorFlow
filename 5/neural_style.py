...
CONTENT_IMG = 'D:/NM02001/Documents/My Pictures/2.jpg'
# The style picture
STYLE_IMG = 'D:/NM02001/Documents/My Pictures/1.jpg'
...
def vgg19(input,model_path = None):
	...
	wDict = np.load(model_path,encoding="bytes").items()
...
def main():
	...
	with tf.Session() as sess:
		...
		for i in range(ITERATION):
			...
			pic = sess.run(combination,feed_dict={myinput:img})
			pic[0] +=123
			pic[1] +=117
			pic[2] +=104
